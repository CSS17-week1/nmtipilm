%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   Matlab code to solve a RBC model by PFI
% 
...
cons1 = bsxfun(@minus, A_high*kgrid'.^alpha ,...
    bsxfun(@max,bsxfun(@minus,kgrid,delta*kgrid'),0) );
cons2 = bsxfun(@minus, A_low*kgrid'.^alpha ,...
    bsxfun(@max,bsxfun(@minus,kgrid,delta*kgrid'),0) );
